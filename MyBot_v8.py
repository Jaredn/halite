...
try:
    ...
    while True:
        ...
        initial_3_planets = []
        LOG.info('MY SHIPS: %s     %s', len(my_ships), my_ships)
        ...
        for ship in my_ships:
            ...
            if nearest_unowned_planet and (ship.id % 2 == 0):
                LOG.info('SHIP %s going to nearest unowned planet %s', ship.id, nearest_unowned_planet)
